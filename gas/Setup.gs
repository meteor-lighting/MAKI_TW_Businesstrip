function setupDatabase() {
  ...
  const sheets = [
    ...
    { name: 'Report Header', headers: ['報告編號', '代墊人報告編號', '用戶編號', '商旅天數', '機票費總額', '個人住宿費總額', '總體住宿費總額', '計程車費總額', '網路費總額', '社交費總額', '禮品費總額', '手續費總額', '日支費總額', '預支費用總額', '其他費用總額', 'USD匯率', '合計TWD個人總額', '合計TWD總體總額', '合計USD個人總額', '合計USD總體總額', '合計TWD個人平均', '合計TWD總體平均', '合計USD個人平均', '合計USD總體平均', '建立時間'] },
    { name: 'Flight', headers: ['報告編號', '次序', '日期', '航班代號', '出發地', '抵達地', '出發時間', '抵達時間', '幣別', '金額', 'TWD金額', '匯率', '備註'] },
    { name: 'Accommodation', headers: ['報告編號', '次序', '日期', '地區', '飯店', '天數', '幣別', '個人金額', 'TWD個人金額', '代墊金額', 'TWD代墊金額', '總體金額', 'TWD總體金額', '代墊人數', '每人每天金額', '匯率', '備註'] },
    ...
    { name: 'Per Diem', headers: ['報告編號', '次序', '開始日期', '結束日期', '地區', '幣別', '金額', 'TWD金額', '匯率', '備註'] },
