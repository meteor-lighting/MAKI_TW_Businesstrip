function setupDatabase() {
  ...
  const sheets = [
    ...
    {
      name: 'Report Header',
      headers: ['報告編號', '用戶編號', '員工姓名', '部門名稱', '職稱', '出差事由', '出差地點', '商旅天數', '商旅起始日', '商旅結束日', 'USD匯率', '建立時間', '最後修改時間', '狀態', '報告名稱']
    },
    { name: 'Flight', headers: ['報告編號', '次序', '日期', '航班代號', '出發地', '抵達地', '出發時間', '抵達時間', '幣別', '金額', 'TWD金額', '匯率', '備註', '行程類型', '回程日期', '回程航班代號', '回程出發地', '回程抵達地', '回程出發時間', '回程抵達時間'] },
    ...
    { name: 'Parking', headers: ['報告編號', '次序', '日期', '地區', '幣別', '金額', 'TWD金額', '匯率', '備註'] },
