        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="space-y-1">
                    ...
                    <input type="text" value={formData.地區} onChange={e => setFormData({ ...formData, 地區: e.target.value })} className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none" placeholder="e.g. Tokyo" required />
                </div>
                <div className="space-y-1">
