...
export default function SocialForm({ reportId, headerRate, tripStartDate, onSubmitSuccess, onLoadingChange, disabled = false, editingItem, onCancelEdit }: SocialFormProps) {
    const { t } = useTranslation();
    const { register, handleSubmit, watch, setValue, control, formState: { errors } } = useForm<SocialFormData>({
        defaultValues: {
            currency: 'TWD',
            amount: '',
            rate: 1,
